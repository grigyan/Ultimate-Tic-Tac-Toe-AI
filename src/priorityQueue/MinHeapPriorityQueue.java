...
public class MinHeapPriorityQueue<K,V> extends AbstractPriorityQueue<K,V> {
  ...
  public MinHeapPriorityQueue() { super(); }

  /**
   * Creates an empty priority queue using the given comparator to order keys.
   * @param comp comparator defining the order of keys in the priority queue
   */
  public MinHeapPriorityQueue(Comparator<K> comp) { super(comp); }
   ...
   */
  public MinHeapPriorityQueue(K[] keys, V[] values) {
    super();
  ...
  public Entry<K,V> removeMin() {
    ...
    int randomFromZeroToIndex = new Random().nextInt(index  + 1);
    answer = heap.get(randomFromZeroToIndex);

    swap(0, randomFromZeroToIndex);
